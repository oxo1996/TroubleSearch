"""
Django settings for cd_project project.
...
SECRET_KEY = 'r_ue8pr)#4@fmp=x9q*x^o896346(f3n1=u$b^)d73j^eonmz-'
...
WSGI_APPLICATION = 'cd_project.wsgi.application'
